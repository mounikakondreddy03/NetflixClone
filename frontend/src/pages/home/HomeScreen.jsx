...
import { MOVIE_CATEGORIES, ORIGINAL_IMG_BASE_URL, TV_CATEGORIES } from '../../utils/contansts';
        ...
        <div className='relative h-screen text-white '>
          ...
          <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
            ...
            <div className='flex mt-8'>
              ...
              <Link to={`/watch/${trendingContent?.id}`} className='bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded flex items-center' > <Info className='size-6 mr-2' /> More Info </Link>
            </div>
          </div>
        </div>
