...
const SMALL_IMG_BASE_URL = require('../utils/contansts')
		...
		<div className='bg-black text-white min-h-screen'>
			...
			<div className='max-w-6xl mx-auto px-4 py-8'>
              ...
              <img src={SMALL_IMG_BASE_URL + entry.image} alt='History image' className='size-16 rounded-full object-cover mr-4' />
							...
							<span
								className={`py-1 px-3 min-w-20 text-center rounded-full text-sm  ml-auto ${entry.searchType === "movie" ? "bg-red-600" : entry.searchType === "tv" ? "bg-blue-600" : "bg-green-600" }`}> {entry.searchType[0].toUpperCase() + entry.searchType.slice(1)} </span>
