...
import { ORIGINAL_IMG_BASE_URL}  from "../utils/contansts";
		...
		<div className='bg-black min-h-screen text-white'>
			...
			<div className='container mx-auto px-4 py-8'>
				...
				<form className='flex gap-2 items-stretch mb-8 max-w-2xl mx-auto' onSubmit={handleSearch}>
					<input type='text' placeholder={"Search for a " + activeTab} className='w-full p-2 rounded bg-gray-800 text-white' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
					<button className='bg-red-600 hover:bg-red-700 text-white p-2 rounded'> <Search className='size-6' /> </button>
				</form>
